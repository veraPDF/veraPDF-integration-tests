...
[![Build Status](https://jenkins.openpreservation.org/job/veraPDF/job/1.24rc/job/integration-tests/badge/icon)](https://jenkins.openpreservation.org/job/veraPDF/job/1.24rc/job/integration-tests/ "OPF Jenkins")

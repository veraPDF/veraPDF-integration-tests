...
[![Build Status](https://jenkins.openpreservation.org/job/veraPDF/job/1.28rc/job/integration-tests-arlington/badge/icon)](https://jenkins.openpreservation.org/job/veraPDF/job/1.28rc/job/integration-tests-arlington/ "OPF Jenkins")

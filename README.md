...
[![Build Status](https://jenkins.openpreservation.org/job/veraPDF/job/1.30/job/integration-tests-jakarta/badge/icon)](https://jenkins.openpreservation.org/job/veraPDF/job/1.30/job/integration-tests-jakarta/ "OPF Jenkins")

/*
 * This file is part of veraPDF PDF Regression Tests, a module of the veraPDF project.
 * Copyright (c) 2015-2026, veraPDF Consortium <info@verapdf.org>
 * All rights reserved.
 *
 * veraPDF PDF Regression Tests is free software: you can redistribute it and/or modify
 * it under the terms of either:
 *
 * The GNU General public license GPLv3+.
 * You should have received a copy of the GNU General Public License
 * along with veraPDF PDF Regression Tests as the LICENSE.GPL file in the root of the source
 * tree.  If not, see http://www.gnu.org/licenses/ or
 * https://www.gnu.org/licenses/gpl-3.0.en.html.
 *
 * The Mozilla Public License MPLv2+.
 * You should have received a copy of the Mozilla Public License along with
 * veraPDF PDF Regression Tests as the LICENSE.MPL file in the root of the source tree.
...
public class PDFRegressionTestUtils {
    private static final EnumSet<PDFAFlavour> flavours = EnumSet.of(PDFAFlavour.PDFA_1_A, PDFAFlavour.PDFA_1_B,
            ...
            PDFAFlavour.PDFUA_1, PDFAFlavour.PDFUA_2, PDFAFlavour.NO_FLAVOUR);
